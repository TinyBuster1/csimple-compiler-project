...
{
  "$end", "error", "$undefined", "T_BOOLEAN", "T_CHAR", "T_VOID",
  "T_INTEGER", "T_STRING", "T_P_INT", "T_P_CHAR", "T_NULL", "OP_AND",
  "OP_DIVIDE", "OP_ASSIGMENT", "OP_EQUAL", "OP_GT", "OP_GTE", "OP_LT",
  "OP_LTE", "OP_MINUS", "OP_NOT", "OP_NOTEQUAL", "OP_OR", "OP_PLUS",
  "OP_MUL", "OP_ADDRESS", "OP_CONTENT", "C_IF", "C_ELSE", "L_WHILE",
  "L_DOWHILE", "L_FOR", "K_RETURN", "LT_TRUE", "T_FASLE", "LT_CHAR",
  ...
  "T_L_BRACKET", "$accept", "s", "expr", YY_NULLPTR
};
#endif
...
#line 41 "parser.y" /* yacc.c:1646  */
    { (yyval) = make_node("OP_PLUS",(yyvsp[-2]),(yyvsp[0]));}
#line 1329 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 42 "parser.y" /* yacc.c:1646  */
    {(yyval) = make_node("T", NULL, NULL);}
